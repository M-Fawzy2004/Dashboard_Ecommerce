            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(child: Text('TOTAL ORDER', style: _headerStyle)),
                  Expanded(child: Text('STATUS', style: _headerStyle)),
                  Expanded(child: Text('PRICE', style: _headerStyle, textAlign: TextAlign.end)),
                ],
              ),
            ),
            ...products.map((p) => Padding(
                  ...
                  child: Row(
                    children: [
                      Expanded(
                        ...
                        child: Row(
                          children: [
                            ...
                            SizedBox(width: 8.w),
                            Text(p['name']!, style: _cellStyle),
                          ],
                        ),
                      ),
                      Expanded(child: Text(p['total']!, style: _cellStyle)),
                      Expanded(
                        child: Row(
                          children: [
                            Container(
                      ...
                      Expanded(child: Text(p['price']!, style: _cellStyle.copyWith(fontWeight: FontWeight.w700), textAlign: TextAlign.end)),
                    ],
                  ),
                )),
            AppSpacing.v20,
